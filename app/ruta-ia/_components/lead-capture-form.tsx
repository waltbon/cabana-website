...
const ORG_SIZES = ["50-150", "150-500", "500+"] as const;
const TIERS = ["Essentials", "Standard", "Enterprise"] as const;
...
const leadSchema = z
  .object({
    ...
    orgSize: z.enum(ORG_SIZES, {
      errorMap: () => ({ message: "Selecciona el tamaño de tu organización." }),
    }),
              ...
              <FormItem className={cn(layout === "grid" && "space-y-1 mb-3", "col-span-full")}>
                ...
                <FormControl>
                  <select
                    ...
                    className={selectClass}
                  >
                    <option value="">No estoy seguro / a definir en la llamada</option>
                    {TIERS.map((tier) => (
